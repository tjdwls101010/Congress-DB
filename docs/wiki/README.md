...
22대 국회(2024-05-30~ )의 **발의 의안 · 본회의 표결 · 회의록 발언**을 담은 공개 Postgres 데이터베이스입니다. 누구나 **읽기전용 SQL로 자유롭게** 조회할 수 있습니다 — 별도 SDK나 API 키 없이, 어떤 Postgres 클라이언트로든 바로 붙어서 `SELECT`를 던지면 됩니다.
...
- **발의자·공동발의자·정당·위원회·회의·표결**을 SQL로 자연스럽게 연결
...
- 의안 약 **18,400건** · 본회의 표결 약 **47만 행** · 회의록 발언 약 **138만 건** · 공포 약 **1,365건** · 의원 320명
