...
50. 시스템은 *대안반영폐기*된 원안과 그 내용을 흡수한 **대안** 법안의 연결을 `bill_relations`(absorbed_bill_id → alternative_bill_id)에 적재한다 (현재 폐기 원안 3,676건, 연결고리 없음).
51. 시스템은 통과한 (대안) 법안의 요약(제안이유·주요내용)을 백필한다 (현재 741건 중 요약 0건).
